                ...
                <form action="{{route('kelas.update',$id->id)}}" method="post">
                    ...
                    <div class="form-group col-md-3 col-3 mt-0 ml-5">
                      ...
                      <div class="form-group col-md-3 col-3 mt-0 ml-5">
                        ...
                        <div class="selectgroup w-100">
                          <label class="selectgroup-item">
                            <input type="radio" name="jurusan" value="IPA" class="selectgroup-input" {{$id->jurusan=='IPS' ? 'checked=""' : ''}}>
                            <span class="selectgroup-button">IPA</span>
                          </label>
                          <label class="selectgroup-item">
                            <input type="radio" name="jurusan" value="IPS" class="selectgroup-input" {{$id->jurusan=='IPA' ? 'checked=""' : ''}}>
