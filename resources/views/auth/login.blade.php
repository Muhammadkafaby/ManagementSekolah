        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="../storage/logo/1.jpg" alt="logo" width="100" class="shadow-light rounded-circle">
            </div>



            <div class="card card-primary">
              <div class="card-header text-center"><h4>SISTEM AKADEMI SMANU KAPLONGAN</h4>
              </div>
    ...
    <div class="float-right">
          ...
          @endphp
            ...
            <div class="simple-footer">
              Copyright &copy; 2023 - Muhammad Kafaby
